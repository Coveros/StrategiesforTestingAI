...
4. Ability to view tool calls or traces using Agent Mode in the UI.
5. Instructor mode enabled to force trace visibility and crew mode when needed.
6. Section 9 automation suite available in Codespaces: `python section9_agentic_test_suite.py`.
